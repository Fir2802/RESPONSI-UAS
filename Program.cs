    ...
    class Program
    {
        ...
        static void TambahCustomer()
        {
           ...
           Console.WriteLine("Tambah Data Customer\n");
            ...
            customer.Kode_Customer=Console.ReadLine();
        ...
        static void HapusCustomer()
        {
          ...
          Console.WriteLine("Hapus Data Customer");
            ...
            if (daftarCustomer.Any(list1 => list1.Kode_Customer == hapus))
            {
                daftarCustomer.RemoveAll(list2 => list2.Kode_Customer == hapus);
        ...
        static void TampilCustomer()
        {
            ...
            foreach (Customer customer in daftarCustomer)
            {
                ...
                Console.WriteLine("{0}. {1}, {2}, {3}", show, customer.Kode_Customer, customer.Nama_Customer, customer.Piutang);
